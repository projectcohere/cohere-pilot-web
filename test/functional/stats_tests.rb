...
class StatsTests < ActionDispatch::IntegrationTest
  ...
  test "processes case events" do
    ...
    input = <<-CSV.strip_heredoc
      ...
      "Did View Governor Form","#{case1.id}",#{etime(case_t1, 1)},1,"$mixpanel","rBzbnzysdnAzthAt","2.2.1",false,"meap","ruby",1582208110737,4,,,
      ...
      "Did View Governor Form","#{case2.id}",#{etime(case_t2, 1)},1,"$mixpanel","CveEbrmByshsksdn","2.2.1",false,"meap","ruby",1583428822968,5,,,
